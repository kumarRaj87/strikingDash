            ...
            <div>
              ...
              >
                ...
                <ZoomableGroup zoom={position.zoom} center={position.coordinates} onMoveEnd={handleMoveEnd}>
                    ...
                    {({ geographies }) =>
                      geographies.map((geo) => (
                        <Geography
                          ...
                          className="transition-colors fill-gray-200 stroke-white hover:fill-indigo-500 active:fill-red-600"
                        />
                      ))
                    }
                  </Geographies>
                  ...
                  {markers.map(({ name, coordinates }) => (
                    <Marker key={name} coordinates={coordinates}>
                      <g className="fill-white stroke-indigo-500 stroke-[6]">
                        <circle cx="8" cy="8" r="8" stroke="none" />
                        <circle cx="8" cy="8" r="6" fill="none" />
                      </g>
                    </Marker>
              ...
              <div className="controls">
                <button type="button" onClick={handleZoomIn}>1
                  <svg
                ...
                <button type="button" onClick={handleZoomOut}>2
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
