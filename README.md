...
```
cd existing_repo
git remote add origin https://gitlab.com/oyeclients/gosh/strikingdash.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/oyeclients/gosh/strikingdash/-/settings/integrations)
